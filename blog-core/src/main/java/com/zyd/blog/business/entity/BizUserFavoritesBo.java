 ...
 * @since 1.0
 */
public class BizUserFavoritesBo {
    private BizUserFavorites bizUserFavorites;

    public BizUserFavoritesBo() {
        this.bizUserFavorites = new BizUserFavorites();
    }

    public BizUserFavoritesBo(BizUserFavorites bizUserFavorites) {
